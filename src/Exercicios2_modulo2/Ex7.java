...
public class Ex7 {
	...
	public static void main(String[] args) {
		...
		switch (code) {
		case 123 : 
			System.out.printf("\nCompra efetuada! Quantidade: "+quantity+" | Valor: R$ %.2f", (quantity * 0.20));
			break;
		case 124 :
			System.out.printf("\nCompra efetuada! Quantidade: "+quantity+" | Valor: R$ %.2f", (quantity * 2.50));
			break;
		case 125 :
			System.out.printf("\nCompra efetuada! Quantidade: "+quantity+" Z Valor: R$ %.2f", (quantity * 0.25));
			break;
		default :
